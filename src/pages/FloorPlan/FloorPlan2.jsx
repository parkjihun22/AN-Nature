  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="84타입의평면 안내 페이지는 브레인시티 앤네이처 미래도의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="브레인시티 앤네이처 미래도 - 84타입 평면도"
        />
        <meta
        ...
        <script type="application/ld+json">
          {`
				...
				"@type": "WebPage",
				"name": "브레인시티 앤네이처 미래도 - 84타입 평면도",
				"description": "84타입의평면 안내 페이지는 브레인시티 앤네이처 미래도의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.",
      ...
      <h1 className={styles.screenReaderOnly}>
        브레인시티 앤네이처 미래도 - 84A평면안내
      </h1>
      <p className={styles.screenReaderOnly}>
        84타입의평면 안내 페이지는 브레인시티 앤네이처 미래도의 각 아파트 평면도를
