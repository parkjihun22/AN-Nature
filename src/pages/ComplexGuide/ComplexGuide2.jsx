  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>브레인시티 앤네이처 미래도 - 호수배치도</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://niceoi.kr/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="브레인시티 앤네이처 미래도 - 호수배치도"
        />
        <meta
      ...
      <img
        ...
        src={page1}
        alt="브레인시티 앤네이처 미래도 호수배치도-image1"
